      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="md:col-span-2 flex justify-center">
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-md cursor-pointer transition"
            >
              Send Message
            </button>
          </div>
